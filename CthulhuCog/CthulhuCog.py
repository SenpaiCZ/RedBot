...
class CthulhuCog(commands.Cog):
    ...
    async def cthulhu(self, ctx):
        description = (
            ...
            ":bulb:`!randomname gender` :arrow_right: Generate random name form 1920s era. (e.g. `!randomname female`)\n"
            ":bulb:`!newInv Inv-name` :arrow_right: Create a new investigator (e.g. `!newInv Oswald Chester Razner`)\n"
            ":bulb:`!autoChar` :arrow_right: Generates random stats for your investigator. You can re-roll, dismiss or save stats.\n"
            ":bulb:`!cstat stat-name` :arrow_right: Edit your investigators stats. (e.g. `!cstat STR 50`)\n"
            ":bulb:`!sinfo skill-name` :arrow_right: Get information about specific skill (without skill-name you will get list of skills). (e.g. `!sinfo Listen`)\n"
            ":bulb:`!cskill skill-name number` :arrow_right: Edit your investigators skill. (e.g. `!cskill Listen 50`)\n"
            ":bulb:`!oinfo occupation-name` :arrow_right: Get information about occupation (without occupation-name you will get list of occupations). (e.g. `!oinfo bartender`)\n"
            ":bulb:`!myChar` :arrow_right: Show your investigators stats and skills. With @ you can show other players stats (e.g. `!myChar @potato`)\n"
            ":bulb:`!d YDX` :arrow_right: Roll dice (e.g. `!d 3D6` or `!d 3D6 + 1D10` or `!d 1D6 + 2`)\n"
            ":bulb:`!d skill-name` :arrow_right: Roll D100 against a skill (e.g. `!d Listen`)\n"
            ":bulb:`!db skill-name` :arrow_right: Roll D100 with bonus die against a skill (e.g. `!db Listen`)\n"
            ":bulb:`!dp skill-name` :arrow_right: Roll D100 with penality die against a skill (e.g. `!dp Listen`)\n"
            ":bulb:`!mb` :arrow_right: Show your investigators inventory and backstory\n"
            ":bulb:`!cb category - item` :arrow_right: Add a record to your backstory or inventory (e.g. `!cb Inventory - Colt .45 Automatic M1911` or `!cb Significant People - Mr. Pickles`)\n"
            ":bulb:`!rb category itemID` :arrow_right: Remove a record from your backstory or inventory. You can see ID with `!mb` (e.g. `!cb Inventory 1`)\n"
            ":bulb:`!gbackstory` :arrow_right: Generate random backstory for your investigator. This will not be saved.\n"
            ":bulb:`!deleteInvestigator` :arrow_right: Delete your investigator, all data, backstory and inventory. You will be promptet to write your investigators name to confirm deletion.\n"
            ":bulb:`!cyear number` :arrow_right: Get basic information about events in year (1890-2012) (e.g. `!cyear 1920`)\n"
            ":bulb:`!firearm name` :arrow_right: Get basic information about firearms. If you use just `!firearm` you will get list of firearms. (e.g. `!firearm m1911`)\n"
            ":bulb:`!randomLoot` :arrow_right: Generate random loot from 1920s. 25% chance of finding $0.1-$10. This will not be saved.\n"
            ":bulb:`!rskill skill1 skill2` :arrow_right: Rename skill to your liking. (e.g. `!rskill Language (other) German`)\n"
            ":bulb:`!cNPC gender` :arrow_right: Generate NPC with random name and stats. (e.g. `!cNPC male`)\n"
            ":bulb:`!showUserData` :arrow_right: Debug command showing raw user data (stats, skill, backstory)\n"
        )
